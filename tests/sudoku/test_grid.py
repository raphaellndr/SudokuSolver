...
@pytest.mark.parametrize(
    ...
    [
        (
            (0, 1),
            # fmt: off
            [1, 4, 5, 6, 8, 9, 1, 5, 6, 7, 8, 9, 3, 4, 7, 8, 9, 8, 9, 9, 3, 5, 6, 8, 9, 4, 8, 9, 3,
            4, 7, 8, 9, 3, 5, 6, 7, 8, 9, 1, 4, 5, 6, 7, 9, 6, 7, 9, 8, 9],
            # fmt: on
        ),
        (
            (8, 7),
            # fmt: off
            [1, 5, 6, 9, 1, 2, 6, 9, 3, 6, 7, 9, 2, 6, 7, 9, 1, 9, 2, 5, 8, 9, 6, 9, 3, 6, 9, 1, 5,
            6, 9, 1, 6, 9, 6, 7, 9, 3, 6, 7, 9],
            # fmt: on
        ),
    ],
)
